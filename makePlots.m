...
% Linear Results
Linear_miceError = dlmread('C:\Users\emahrt\Documents\mice_predictions\linear\micePredictError.txt', '\t', 0, 2);
Linear_miceError = Linear_miceError(:);

% Dist4 Results
Dist4_miceError = dlmread('C:\Users\emahrt\Documents\mice_predictions\distorted4\micePredictError.txt', '\t', 0, 2);
Dist4_miceError = Dist4_miceError(:);

% Dist10 Results
Dist10_miceError = dlmread('C:\Users\emahrt\Documents\mice_predictions\distorted10\micePredictError.txt', '\t', 0, 2);
Dist10_miceError = Dist10_miceError(:);

% Dist20 Results
Dist20_miceError = dlmread('C:\Users\emahrt\Documents\mice_predictions\distorted20\micePredictError.txt', '\t', 0, 2);
